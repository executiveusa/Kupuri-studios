...
# This folder and file are protected by SYSTEM_ARCHITECTURE_CRITICAL.md and DELETION_PROTECTION.md.
# Do NOT delete or modify without explicit approval.
# See README.md and SYSTEM_ARCHITECTURE_CRITICAL.md for details.
