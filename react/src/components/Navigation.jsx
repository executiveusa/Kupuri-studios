  ...
  return (
    <nav className="fixed top-4 left-4 right-4 z-50 bg-white/80 backdrop-blur-lg border border-gray-200 rounded-lg">
      <div className="max-w-6xl mx-auto px-6 py-4 flex items-center justify-between">
        ...
        <Link href="/" className="flex items-center gap-2 text-xl font-bold text-slate-900 hover:text-slate-600 transition-colors cursor-pointer focus-visible:ring-2 focus-visible:ring-purple-600 rounded-lg px-2 py-1">
