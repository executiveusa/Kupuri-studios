...
- [ ] **Navbar**:
    ...
    -   Add links to "Library" (`/assets`) and "Knowledge" (`/knowledge`) if appropriate for public view, or hide them behind auth.
- [ ] **Showcase Section**:
...
- [ ] **Feature Activation**:
    ...
    -   **Goal**: Connect it to the backend to actually *create* and *save* agents.
...
2.  **Fix the "Enter Studio" Flow**: Ensure the transition from Landing -> Canvas is smooth and guided.
